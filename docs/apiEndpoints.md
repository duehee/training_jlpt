...
> 관련 문서: `serviceFlows.md`, `databaseSchema.md`, `implementationRoadmap.md`
...
- DB 테이블 구조 → `databaseSchema.md`
- 구현 순서/일정 → `implementationRoadmap.md`
- 설계 결정 배경 → `decisionLog.md`
...
`databaseSchema.md` 4-4장의 **핵심 트랜잭션**을 실행하는 API입니다.
