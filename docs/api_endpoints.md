...
| ID 표기 | URL path는 `snake_case` (`diagnosis_session_id`) — FastAPI 표준, 함수 시그니처 그대로 사용 가능 (decision_log 2026-04-28 D-7) |
...
```
✅ GET    /api/v1/diagnosis/sessions/{diagnosis_session_id}/questions
✅ POST   /api/v1/learning/sessions/{learning_session_id}/answers
...
### 6-2. `GET /api/v1/diagnosis/sessions/{diagnosis_session_id}/questions`
...
### 6-3. `POST /api/v1/diagnosis/sessions/{diagnosis_session_id}/answers`
...
### 6-4. `POST /api/v1/diagnosis/sessions/{diagnosis_session_id}/complete`
...
### 6-5. `GET /api/v1/diagnosis/sessions/{diagnosis_session_id}/result`
...
### 8-2. `GET /api/v1/learning/sessions/{learning_session_id}`
...
### 8-3. `GET /api/v1/learning/sessions/{learning_session_id}/explanation`
...
### 8-4. `POST /api/v1/learning/sessions/{learning_session_id}/question`
...
### 8-5. `POST /api/v1/learning/sessions/{learning_session_id}/answers`
